...
- Name: features.spec.ts >> ETL Anything - Full Feature Verification (F001-F021) >> F012 - Orphaned Node Validation >> should warn about orphaned nodes on save
- Location: e2e/features.spec.ts:171:9
