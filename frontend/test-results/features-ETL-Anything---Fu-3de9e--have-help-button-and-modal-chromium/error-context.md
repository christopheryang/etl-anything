...
- Name: features.spec.ts >> ETL Anything - Full Feature Verification (F001-F021) >> F020 - Help Modal >> should have help button and modal
- Location: e2e/features.spec.ts:289:9
...
Error: locator.click: Error: "has" engine expects non-empty selector list
    ...
    at SelectorEvaluatorImpl._cached (<anonymous>:5048:20)
Call log:
  - waiting for locator('button:has svg').filter({ hasText: 'Menu' }).first()
