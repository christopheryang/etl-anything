...
- Name: features.spec.ts >> ETL Anything - Full Feature Verification (F001-F021) >> F006 - Model Mapping Expansion >> reasoning node should have model dropdown
- Location: e2e/features.spec.ts:87:9
...
Call log:
  - waiting for locator('button:has-text("Reasoning"), .sidebar-item:has-text("Reasoning")').first()
